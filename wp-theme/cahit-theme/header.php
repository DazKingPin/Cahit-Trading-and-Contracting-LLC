...
<div class="modal-overlay" id="contact-popup" style="display:none;" onclick="if(event.target===this)closeContactPopup();">
  <div class="modal-content modal-sm">
    ...
    <div class="contact-list">
      <a href="tel:+96871545981" class="contact-item">
        ...
        <div>
          ...
          <p class="contact-value">+968 7154 5981</p>
        </div>
      </a>
      ...
      <a href="https://wa.me/96871545981" target="_blank" rel="noopener noreferrer" class="contact-item">
        <span class="contact-icon">
      ...
      <div class="contact-item contact-item-static">
        ...
        <div>
          <p class="contact-label">Head Office</p>
          <p class="contact-value contact-address" data-ar-html="ص.ب. 63، الرمز البريدي 101<br>جنوب الموالح، مسقط<br>سلطنة عُمان">P.O. Box 63, PC 101<br>South Mawaleh, Muscat<br>Sultanate of Oman</p>
        </div>
      </div>
    </div>
  </div>
