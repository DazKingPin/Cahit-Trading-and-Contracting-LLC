...
<div class="modal-overlay" id="contact-popup" style="display:none;" onclick="if(event.target===this)closeContactPopup();">
  <div class="modal-content modal-sm">
    ...
    <div class="contact-list">
      <a href="tel:+96824112406" class="contact-item">
        ...
        <div>
          ...
          <p class="contact-value">+968 2411 2406 Ext 101</p>
          <p class="contact-value">+968 9096 6562</p>
        </div>
      </a>
      ...
      <a href="https://wa.me/96890966562" target="_blank" rel="noopener noreferrer" class="contact-item">
        <span class="contact-icon">
      ...
      <div class="contact-item contact-item-static">
        ...
        <div>
          ...
          <p class="contact-value">Khaleej Tower<br>6th Floor, No. 603<br>Ghala, Muscat<br>Sultanate of Oman</p>
        </div>
      </div>
    </div>
  </div>
