(function () {
  ...
  var arTranslations = {
    ...
    "His expertise includes water treatment systems, desalination plants, soil improvement projects, marine construction and Oil & Gas infrastructure works.": "تشمل خبرته أنظمة معالجة المياه ومحطات التحلية ومشاريع تحسين التربة والبناء البحري وأعمال البنية التحتية للنفط والغاز.",
    ...
    "MSc of Environmental Engineering \u2014 Istanbul Technical University": "ماجستير الهندسة البيئية \u2014 جامعة إسطنبول التقنية",
  ...
  var arVideoMap = {
    "about": "/wp-content/themes/cahit-theme/assets/videos/hero-ar.mp4",
