...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative h-64 md:h-80 overflow-hidden" data-testid="section-about-hero">
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0A3D6B]/80 to-sky-600/60 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white" data-testid="text-about-heading">About Cahit Trading & Contracting</h1>
